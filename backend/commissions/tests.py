...
class CommissionExplanationTests(TestCase):
    ...
    def test_ask_offline_when_ai_not_configured(self):
        ...
        self.assertIn("was calculated", data["answer"])
        self.assertIn("monthly aggregate commission", data["answer"])
...
class ProductionAIFeatureTests(TestCase):
    ...
    def test_commission_explanation_returns_deterministic_fallback_for_aggregate(self):
        employee = Employee.objects.create(
            organization=self.org,
            name="AI Rep",
            email=self.rep_user.email,
        ...
        self.assertIn("monthly aggregate commission", payload["answer"])
