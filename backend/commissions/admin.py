...
class ReportScheduleInline(admin.TabularInline):
    ...
    extra = 0
    fields = ("frequency", "delivery", "is_active", "next_run_at", "last_run_at")
...
class ReportAdmin(admin.ModelAdmin):
    ...
    list_filter = ("report_type", "visibility", "is_archived")
    search_fields = ("name", "description")
    inlines = [ReportFieldInline, ReportFilterInline, ReportScheduleInline]
