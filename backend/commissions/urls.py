...
urlpatterns = [
    ...
    path("audit-logs/summary/", audit_log_summary, name="audit-logs-summary"),
    path("audit-logs/security/", audit_log_security, name="audit-logs-security"),
    path("audit-logs/export/", audit_log_export, name="audit-logs-export"),
    path("audit-logs/<int:pk>/", audit_log_detail, name="audit-logs-detail"),
